...
patients — Patient demographics such as birthdate, gender, race, and ZIP.

encounters — Each hospital interaction, including encounter type, start/end time, cost, and payer.

procedures — Procedures performed during encounters, along with categories and base cost.

payers — Insurance or coverage information for encounters.
